...
export default function Home() {
  ...
  return (
    <div className="flex flex-col justify-center items-center bg-red-500 h-screen px-4 md:px-12">
      <div className="flex flex-col items-center bg-white w-full md:max-w-[600px] p-10 h-auto rounded-xl shadow-md">
